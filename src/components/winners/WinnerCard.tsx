                ...
                <CardContent className="space-y-4">
                    ...
                    <div className="flex items-center gap-1">
                        {[1, 2, 3, 4, 5].map((star) => (
                            <Star
                                key={star}
                                className={`w-4 h-4 ${star <= winner.rating
                    ...
                    <div className="pt-2 border-t border-border/50">
                        <Button
                            ...
                            size="sm"
                            onClick={handleLike}
                            className={`gap-2 transition-colors ${liked ? "text-red-500 hover:text-red-400" : "text-muted-foreground hover:text-foreground"
                                }`}
                        >
                            <Heart
