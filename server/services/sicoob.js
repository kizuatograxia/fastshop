...
export const createPixCharge = async (txid, valor, devedor) => {
    ...
    if (!SICOOB_CLIENT_ID) {
        ...
        return {
            txid: txid,
            pixCopiaECola: '00020126580014BR.GOV.BCB.PIX0136123e4567-e89b-12d3-a456-426614174000520400005303986540510.005802BR5913Cicrano de Tal6008BRASILIA62070503***6304E2CA',
            loc: { id: 123 }
        };
    }
